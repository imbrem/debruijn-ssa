...
theorem Eqv.packed_in_let1 {Γ : Ctx α ε} {R : LCtx α}
  ...
  = let1 a.packed (let1 (pair (var 0 Ctx.Var.shead) (var 1 (by simp))) r.packed_in) := by
...
theorem Eqv.packed_in_case {Γ : Ctx α ε} {R : LCtx α}
  ...
  = case a.packed
    (let1 (pair (var 0 Ctx.Var.shead) (var 1 (by simp))) r.packed_in)
    (let1 (pair (var 0 Ctx.Var.shead) (var 1 (by simp))) s.packed_in) := by
...
theorem Eqv.packed_in_cfg {Γ : Ctx α ε} {R L : LCtx α}
  ...
  = cfg R β.packed_in (λi => (let1 (pair (var 0 Ctx.Var.shead) (var 1 (by simp))) (G i).packed_in))
  := by
